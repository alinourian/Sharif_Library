...
public class LibraryB implements Library {

    private static LibraryB instance;
    ...
    public static LibraryB getInstance() {
        if(instance == null) {
            instance = new LibraryB();
        }
        return instance;
    }
    ...
    public AddBook addBook(Book book) {
        ...
        if(test == null) {
            ...
            numbersOfBooks++;
            test.setBookPlace(Libraries.LIBRARY_B);
